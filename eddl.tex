...
\multicolumn{4}{c||}{\textunderscore{}N\textunderscore{}APP} & 
\multicolumn{6}{c|}{\textunderscore{}S\textunderscore{}APP} & 
...
\multicolumn{1}{l}{\scriptsize \begin{tabular}[c]{@{}l@{}}Quelle: Felix Soest (sourcecode), Ann-Christin Schnarre (Inhalt)\end{tabular}}
\end{textblock}
